function [fitness, pop] = buildingBreed_FitnessFunc(pop,p,d)
...
%
% Other m-files required: buildingBreed_test
% See also: buildingBreed_test, buildingBreed_Domain, buildingBreed_StopCriteria
...
parfor iInd = 1:length(pop)
    ind = pop(iInd);
    fitness(iInd) = buildingBreed_test(ind.wMat,ind.aMat,p,d);    
